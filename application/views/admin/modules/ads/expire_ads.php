    ...
    <div class="container">
        <div class="form-card reviews">
            <div class="add_category">
                <h4 class="add_name">Expired Ads</h4>
            </div>
                ...
                <table id="example" style="width: 100%;" class="table table-bordered">
                    ...
                    <tbody>
                        ...
                        if(@!empty($ads))
                        {
                            ...
                            <td>
                                <?php if($ad['product_expiry'] <= date("Y-m-d h:i:s A")){ echo '<span class="badge badge-danger">Expired</span>'; }else { echo '<span class="badge badge-warning">Pending</span>'; } ?>
