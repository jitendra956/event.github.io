    ...
    <div class="container">
       <div class="form-card reviews">
            <div class="add_category">
                <h4 class="add_name">Sub Categories</h4>
            </div>
                ...
                <table id="example" style="width: 100%;" class="table table-bordered">
                    ...
                    <tbody>
                        ...
                        if(@!empty($categories))
                        {
                            ...
                            <td>
                                <a href="javascript:void(0)" class="text-muted">
                                    <input type="checkbox" value="<?php echo $category['CATID']; ?>">
                                </a>
                            </td>
                            ...
                            <td align="center">
                                <table>
                                    <tr>
                                        <td> <a href="<?php echo base_url().'edit-sub-category/'.$category['CATID']; ?>" class="edit-btn">Edit</a>
                                        </td>
