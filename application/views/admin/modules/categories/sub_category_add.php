   ...
   <div class="container">
      ...
      <div class="form-card reviews">
         <div class="add_category">
            <h4 class="add_name">Add a New Sub-Category</h4>
         </div>
         <form id="subCategoryForm" method="post" action="<?php echo base_url().'admin/Categories/add_subcategory'; ?>" enctype="multipart/form-data">
            <div class="row">
               <div class="col-md-12">
               ...
               <div class="col-md-6">
                  <div class="form-group">
                     <label for="name">Sub-Category Arabic Name</label>
